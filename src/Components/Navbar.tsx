...
const Navbar = () => {
	...
	return (
		<nav className="flex items-center justify-between p-4 bg-orange-200 text-gray-800 shadow-md">
			...
			<div className="flex items-center space-x-4">
				...
				{isLoggedIn ? (
					<>
						<button onClick={handleLogout} className="px-4 py-2 bg-orange-600 text-white rounded-full hover:bg-orange-500 transition-colors duration-300 shadow-md">
							Logout
						</button>
						<Link to="/profile" className="text-xl text-gray-800 hover:text-orange-600 transition-colors duration-300">
