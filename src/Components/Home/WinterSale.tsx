	...
	return (
		<div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center p-6">
			...
			<div className="flex flex-col justify-center gap-6">
				<h1
					data-aos="fade-up"
					className="text-3xl sm:text-4xl font-bold text-gray-800 aos-init aos-animate">
					Winter Sale upto 50% Off
				</h1>
				<p
					data-aos="fade-up"
					className="text-sm sm:text-base text-gray-600 leading-6 aos-init aos-animate">
				...
				<div className="flex flex-col gap-4">
					...
					<div
						...
						<svg
							...
							xmlns="http://www.w3.org/2000/svg">
							<path
								d="M267.2 25.08l-70 70.16c-7.7 7.66-7.3 16.86-2.4 26.96l2 4.3-3.1 2.9-23.6 22.3 21.7 21.6 22.2-23.7 2.9-3 4.2 1.9c10.7 5.3 20.6 5.7 27.7-1.4L319 76.85l-10.2-10.18-45.7 45.63-9.6-9.8L299 56.97l-10.9-11.03-45.5 45.7-9.7-9.7 45.5-45.69zM28.97 27.84c-5.73 9.12-6.61 20.83-3.32 34.58 3.87 16.32 13.68 
            ...
            -18zm66.05 82c-12.9 0-23.1 10.2-23.1 23s10.2 23 23.1 23c12.8 0 23-10.2 23-23s-10.2-23-23-23zm310 0c-12.8 0-23 10.2-23 23s10.2 23 23 23 23-10.2 23-23-10.2-23-23-23z"></path>
						</svg>
						<p>Get Offers</p>
					</div>
				</div>
